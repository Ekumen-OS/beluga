...
/// Parameters to construct an omniDriveModel instance.
/**
...
class OmnidirectionalDriveModel : public Mixin {
 public:
  ...
  /// Constructs an omniDriveModel instance.
  /**
  ...
  [[nodiscard]] state_type apply_motion(const state_type& state) const {
    ...
    const auto translation = Eigen::Vector2d{
        distribution(generator, translation_params_), distribution(generator, strafe_params_)};
    ...
    return state * Sophus::SE2d{first_rotation_, Eigen::Vector2d{0.0, 0.0}} * Sophus::SE2d{second_rotation, translation};
  }
