...
def get_launch_arguments():
    ...
    return [
        ...
        DeclareLaunchArgument(
            ...
            description='Localization node to plugin to use if composition is enabled.',
        ),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            name='localization_parameters_file',
    ...
    load_nodes = GroupAction(
        actions=[
            *get_node_with_arguments_declared_from_params_file(
                ...
                params_file=localization_parameters_file,
            ),
            Node(
            ...
            ComposableNodeContainer(
                ...
                composable_node_descriptions=[
                    ComposableNode(
                        ...
                        name='amcl',
                        parameters=[localization_parameters_file],
                    ),
                    ComposableNode(
                        package='nav2_map_server',
