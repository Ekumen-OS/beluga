...
using LaserLocalizationInterface2d =
    beluga::LaserLocalizationInterface2d<beluga_amcl::ROSOccupancyGrid, beluga_amcl::FilterUpdateControlInterface>;
...
std::unique_ptr<LaserLocalizationInterface2d> amcl_pf_from_map(nav_msgs::msg::OccupancyGrid::SharedPtr map) {
  ...
  using LikelihoodField = beluga::mixin::descriptor<
      ciabatta::curry<beluga::LikelihoodFieldModel, beluga_amcl::ROSOccupancyGrid>::mixin,
  ...
  return beluga::mixin::make_mixin<LaserLocalizationInterface2d, AdaptiveMonteCarloLocalization2d>(
      ...
      beluga_amcl::utils::make_occupancy_grid(map), resample_on_motion_params, resample_interval_params,
...
std::unique_ptr<LaserLocalizationInterface2d> beam_mcl_pf_from_map(nav_msgs::msg::OccupancyGrid::SharedPtr map) {
  ...
  using BeamSensorModel = beluga::mixin::descriptor<
      ciabatta::curry<beluga::BeamSensorModel, beluga_amcl::ROSOccupancyGrid>::mixin, beluga::BeamModelParam>;
